...
def upload_entity(
    ...
    if skipped_photos:
        ...
        return {
            "success": False,
            "message": (
                f"Registration failed. Photo {failed_numbers} did not contain "
                "a clear front face. Please click again and recapture."
            ),
            "userid": userid,
            "username": username,
            "photos_registered": 0,
    ...
    if registered_count < MIN_REGISTRATION_PHOTOS:
        return {
            "success": False,
            "message": (
                f"Registration failed. Need at least {MIN_REGISTRATION_PHOTOS} "
